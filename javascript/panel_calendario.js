    ...
    Calendar_Obj = new FullCalendar.Calendar(calendarEl, {
      ...
      eventClick: function (info) {
        ...
        var contenido =
          ...
          '<span style="font-size:18px;"><span style="font-weight:bold;">Servicio: </span>' +
          ...
          json_datos.citas_hora +
          "<br>" +
          '<span style="font-weight:bold;">Notas: </span>' +
          json_datos.citas_notas +
          "<br>" +
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            document.getElementById("select_hora_modal").innerHTML +=
              "<option value='" +
              json_datos.citas_hora +
              "'>" +
              json_datos.citas_hora +
      ...
      eventDrop: function (info) {
        ...
        if (
          Usuiaro_ID != json_datos.citas_proveedor_id &&
          ...
          Toast_a.fire({
            icon: "warning",
            title:
              "No puedes modificar las citas de otro proveedor, favor de contactar al administrador del sistema para verificar.",
          });
        ...
        Swal.fire({
          ...
          backdrop: false,
          title:
            "¿Realmente quieres cambiar la cita a la fecha " +
            obtener_fecha(info.event.start) +
            "?",
          showCancelButton: true,
          icon: "question",
...
function eventos() {
  ...
  $("#btn_guardar_modal").on("click", function (e) {
    ...
    try {
      ...
      if ($("#hid_cita_id").val() == "") {
        if (
          Usuiaro_ID != $("#select_proveedor_modal").val() &&
          Usuario_Rol == "Proveedor"
        ) {
          const Toast_a = Swal.mixin({
            toast: true,
          ...
          Toast_a.fire({
            icon: "warning",
            title:
              "No puedes agendar citas para otro proveedor, favor de contactar al administrador del sistema para verificar.",
          });
  ...
  $(".fc-next-button").on("click", function (e) {
    Fecha_Actual_Calendar = obtener_fecha(
      Calendar_Obj.currentData.viewApi.currentStart
    );
    ...
    try {
      if ($(this).val() != "selecciona") {
        ...
        $.ajax({
          ...
          data: {
            funcion: "consultar_salas_ocupadas",
            fecha: $("#date_fecha_modal").val(),
          },
          async: false,
            ...
            if (datos.length >= 1) {
              for (var i = 0; i < datos.length; i++) {
                ...
                if (
                  evaluar_entre_horas(
                    datos[i].hora_inicio,
                    sumar_minutos(datos[i].hora_inicio, datos[i].duracion),
                    $("#select_hora_modal").val()
                  ) == true
                ) {
  ...
  if ($("#select_cliente_modal").prop("disabled") == true) {
    ...
    if (obtener_campo_validacion("edad_cliente") == "true") {
      if ($("#txt_edad_modal").val() == "")
        ...
        parseInt($("#txt_edad_modal").val(), 10) <= 0 ||
        parseInt($("#txt_edad_edit").val(), 10) >= 150
      )
      ...
      success: function (response) {
        try {
          ...
          if (envio_activo == true) {
            var correo_destino = "";
            var nombre_cliente = $(
              "#select_cliente_modal option:selected"
            ).text();
            var correo_proveedor = "";
            var telefono_proveedor = "";
            var nombre_proveedor = $(
              "#select_proveedor_modal option:selected"
            ).text();
            var nombre_servicio = $(
              "#select_servicio_modal option:selected"
            ).text();
            var mensaje = "";
            var nombre_empresa = "";
            ...
            if ($("#hid_cambio_estatus").val() != "") {
              ...
              mensaje +=
                ...
                ".</span><br>";
              mensaje +=
                "Se le notifica que su cita agendada para el servicio de " +
                nombre_servicio +
              ...
              mensaje += "</ul>";
              mensaje +=
                "<br><br><br>Si no reconoce el motivo de la cancelación, favor de contactar al proveedor del servicio para confirmar.<br>";
              mensaje += "<ul>";
              ...
              mensaje +=
                ...
                ".</span><br>";
              mensaje +=
                "Se le notifica que los datos de su cita para el servicio de " +
                nombre_servicio +
                " han cambiado.<br><br>";
              mensaje += "Datos de la cita:<br>";
              mensaje += "<ul>";
              ...
              mensaje += "</ul>";
              mensaje +=
                "<br><br><br>Si no reconoce el cambio, favor de contactar al proveedor del servicio:<br>";
              mensaje += "<ul>";
              mensaje += "<li>Nombre: " + nombre_proveedor + "</li>";
              mensaje += "<li>Teléfono: " + telefono_proveedor + "</li>";
              mensaje += "<li>Correo: " + correo_proveedor + "</li>";
        ...
        try {
          ...
          if (envio_activo == true) {
            ...
            $.ajax({
              ...
              success: function (response) {
                try {
                  ...
                  telefono_proveedor = jsonData[0].usuarios_telefono;
                  nombre_proveedor =
                    jsonData[0].usuarios_nombre +
                    " " +
                    jsonData[0].usuarios_apellido_p +
                    " " +
                    jsonData[0].usuarios_apellido_m;
                } catch (ex_ajax) {
                  alert("[enviar_correo -> ajax_proveedor]: " + ex_ajax);
                }
              },
            ...
            mensaje +=
              ...
              ".</span><br>";
            mensaje +=
              "Se le notifica que su cita para el servicio de " +
              nombre_servicio +
              ". Ha sido reagendada. Los nuevos datos de la cita son los siguientes:<br><br>";
            mensaje += "Datos de la cita:<br>";
            mensaje += "<ul>";
            ...
            mensaje += "</ul>";
            mensaje +=
              "<br><br><br>Si no reconoce el motivo del cambio, favor de contactar al proveedor del servicio para confirmar.<br>";
            mensaje += "<ul>";
            mensaje += "<li>Nombre: " + nombre_proveedor + "</li>";
            mensaje += "<li>Teléfono: " + telefono_proveedor + "</li>";
            mensaje += "<li>Correo: " + correo_proveedor + "</li>";
    ...
    $.ajax({
      ...
      success: function (datos) {
        if (datos !== null) {
          ...
          document.getElementById("select_servicio_modal").innerHTML +=
    ...
    $.ajax({
      ...
      success: function (datos) {
        if (datos !== null) {
          ...
          if (datos.length == 0)
            document.getElementById("select_proveedor_modal").innerHTML +=
              "<option value='-1'>- seleccionar -</option>";
    ...
    $.ajax({
      ...
      success: function (datos) {
        if (datos !== null) {
          ...
          document.getElementById("select_cliente_modal").innerHTML +=
            "<option value='-1'>- seleccionar -</option>";
          ...
          for (var i = 0; i < datos.length; i++) {
            contenido +=
              ...
              " " +
              datos[i].clientes_apellido_p +
              " " +
              datos[i].clientes_apellido_m +
              "</option>";
          }
        ...
        try {
          ...
          for (var i = 0; i < jsonData.length; i++) {
            ...
            if (
              ...
              $("label[for='txt_nombre_modal']").text(
                $("label[for='txt_nombre_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='txt_apellido_p_modal']").text(
                $("label[for='txt_apellido_p_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='txt_apellido_m_modal']").text(
                $("label[for='txt_apellido_m_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='txt_telefono_modal']").text(
                $("label[for='txt_telefono_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='txt_domicilio_modal']").text(
                $("label[for='txt_domicilio_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='txt_correo_modal']").text(
                $("label[for='txt_correo_modal']").text() + " (*)"
              );
            ...
            if (
              ...
              $("label[for='select_sexo_modal']").text(
                $("label[for='select_sexo_modal']").text() + " (*)"
              );
      ...
      success: function (response) {
        try {
          ...
          if (jsonData.mensaje == "correcto") {
            ...
            Swal.fire({
              title:
                "Ha ocurrido un error actualizando la cita, favor de intentarlo más tarde",
              icon: "error",
              confirmButtonText: `Salir`,
            }).then((result) => {
              $("#modal_cita").modal("hide");
      ...
      success: function (data) {
        ...
        if (datos.length >= 1) {
          ...
          if (citas_pendientes.length >= 1) {
            var contenido =
              '<div style="width:100%; height:350px; max-height:350px; overflow-y:scroll;">' +
            ...
            for (var i = 0; i < citas_pendientes.length; i++) {
              contenido +=
                ...
                ", " +
                citas_pendientes[i].citas_hora +
                ") " +
                citas_pendientes[i].servicios_nombre +
                "</td>" +
                "<td><button class='btn btn-primary' onclick='activar_editar(" +
                JSON.stringify(citas_pendientes[i]) +
                ")'>Editar</button></td></tr>";
            }
            ...
            Swal.fire({
              title:
                "Tienes nuevas citas registradas.<br> asígnales una ubicación",
              width: 800,
              padding: "10px",
              html: contenido,
            });
