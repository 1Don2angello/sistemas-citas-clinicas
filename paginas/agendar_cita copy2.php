    ...
    <div id="paso_3" class="contenedor_paso contendedor_formulario">
      ...
      <div class="row" style="margin-bottom: 20px">
        ...
        <div class="col-lg-4">
          ...
          <input type="text" id="txt_nombre" class="form-control" style="width: 100%" value="<?php echo $rows["Nombre"] ?>" readonly /><!--  readonly -->
        </div>

        <div class="col-lg-4">
          <label for="txt_apellido_p" style="font-weight: bold">Apellido Paterno :</label>
          <input type="text" id="txt_apellido_p" class="form-control" style="width: 100%" value="<?php echo $rows["Paterno"] ?>" readonly /><!-- readonly -->
        </div>

        <div class="col-lg-4">
          <label for="txt_apellido_m" style="font-weight: bold">Apellido Materno :</label>
          <input type="text" id="txt_apellido_m" class="form-control" style="width: 100%" value="<?php echo $rows["Materno"] ?>" readonly /><!--  readonly -->
        </div>
      </div>
        <div class="col-lg-6">
          <label for="txt_domicilio" style="font-weight: bold">Depto :</label>
          <input type="text" id="txt_domicilio" class="form-control" style="width: 100%" value="<?php echo $rows["Depto"] ?>" readonly /><!-- readonly -->
        </div>
      </div>
      <div class="row" style="margin-bottom: 20px">
        <div class="col-lg-6">
      ...
      <div class="row" style="margin-bottom: 20px">
        <div class="col-lg-6">
          ...
          <input type="text" id="txt_correo" class="form-control" style="width: 100%" /><!-- agregar readonly -->
        </div>
        ...
        <div class="col-lg-3">
          ...
          <input type="number" id="txt_edad" class="form-control" style="width: 100%" /><!-- agregar readonly -->
        </div>
      </div>
