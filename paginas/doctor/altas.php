                                    ...
                                    ?>
                                     <thead>
                                         ...
                                         <tr>
                                             ...
                                             <td colspan="1" style="width: auto;"><?php echo $fila2["escolaridad"] ?></td>
                                             ...
                                             <td colspan="2" style="width: auto;"><?php echo $fila2["lugarOrigen"] ?></td>
                                         </tr>
                                         ...
                                         <tr>
                                             ...
                                             <td colspan="7" style="width: auto;"><?php echo $fila2["visitarUFM"] ?></td>

                                         </tr>
                                         <tr>
                                             <th colspan="1" scope="col">Observaciones</th>
                                             <td colspan="4" style="width: auto;"><?php echo $fila2["observaciones"] ?></td>
                                             <th colspan="1" scope="col">indicaciones</th>
                                             <td colspan="7" style="width: auto;"><?php echo $fila2["indicaciones"] ?></td>
                                         </tr>
                                         <tr>
                                         ...
                                         <tr>
                                             ...
                                             <td colspan="1" style="width: auto;"><?php echo $fila2["envioOpto"] ?></td>
                                             <th colspan="1" scope="col">Examenes de Laboratorio</th>
                                             <td colspan="" style="width: auto;"><?php echo $fila2["examLab"] ?></td>
                                             <th colspan="1" scope="col">Licencia Indica Uso de Lentes</th>
                                             <td colspan="4" style="width: auto;"><?php echo $fila2["licenciaLentes"] ?></td>
                                         </tr>
                                         <!-- Resto de las columnas -->
                                         <!-- Salto de línea -->
                                         <tr>
                                             ...
                                             <td colspan="1" style="width: auto;"><?php echo $fila2["tipoSangre"] ?></td>
                                             <th colspan="1" scope="col">Riesgo para la Salud</th>
                                             <td colspan="1" style="width: auto;"><?php echo $fila2["riesgoSalub"] ?></td>
                                             <th colspan="1" scope="col">Perimetro Abdominal</th>
                                             <td colspan="4" style="width: auto;"><?php echo $fila2["perAbdominal"] ?></td>
                                         </tr>
                                         <tr>
                                         ...
                                         <tr>
                                             ...
                                             <td colspan="4" style="width: auto;"><?php echo $fila2["horaAplicacion"] ?></td>
                                         ...
                                         <tr>
                                             ...
                                             <td colspan="4" style="width: auto;"><?php echo $fila2["resultado"] ?></td>
                                             <th colspan="1" scope="col">Diagnostico</th>
                                             <td style="width: auto;" colspan="7"><?php echo $fila2["diagnostico"] ?></td>
                                         </tr>
                                         <tr>
