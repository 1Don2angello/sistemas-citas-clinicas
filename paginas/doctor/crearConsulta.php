                        ...
                        <form action="procesoConsulta.php" method="POST">
                            ...
                            <div>
                                <tr>
                                    ...
                                    <th>
                                        <input class="sinborde" type="text" name="clave" id="clave" value="">
                                    </th>
                                    <th colspan="1">
                                        <button id="buscar-btn" type="button">Buscar</button>
                                    </th>
                                    <th colspan="" class="nombre">Nombre<br>
                                        <input type="text" readonly name="nombre" id="nombre_completo" value="" style="width: 600px;">
                                    </th>
                                </tr>
